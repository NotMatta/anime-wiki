import { BookOpen, Search, TvMinimalPlay } from "lucide-react"

const NavBar = () => {
    return (
        <div className="p-2 box-border w-full border-b flex justify-between h-18 sticky top-0 bg-background">
            ...
            <div className="hidden w-1/2 lg:flex items-center justify-around">
                <div className="border-b flex items-center gap-2 py-2">
                    <Search/>
                    <input className="bg-transparent border-none focus-visible:outline-none" placeholder="Search.."/>
                </div>
                <a className="hover:pb-2 hover:border-b cursor-pointer duration-200 flex gap-1 items-center"><TvMinimalPlay/> Anime</a>
                <a className="hover:pb-2 hover:border-b cursor-pointer duration-200 flex gap-1 items-center"><BookOpen/>Manga</a>
            </div>
        </div>
    )
}
